Rails.application.routes.draw do
  ...
  get '/ownerships/:id/trades/new', to: 'trades#new', as: 'noo_trade'
  post '/ownerships/:id/trades/new', to: 'trades#create'
  get '/ownerships/:id/edit', to: 'ownerships#edit', as: 'purchase'
  patch '/ownerships/:id/', to: 'ownerships#update', as: 'ex_purchase'
